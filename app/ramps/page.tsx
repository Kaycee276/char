          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 neu-card rounded-3xl p-6 sm:p-8 border border-white/80 space-y-6">
              <div className="flex items-center justify-between border-b border-slate-300/40 pb-4">
                ...
                <span className="px-3 py-1 rounded-full text-xs font-black neu-inset text-orange-800">
              ...
              {!isSuccess ? (
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <input
                          ...
                          className="bg-transparent font-mono text-2xl font-black text-slate-950 focus:outline-none w-36"
                        />
                      </div>
                    </div>

                    <div className="text-right">
                      <span className="text-[10px] font-extrabold uppercase tracking-wider text-orange-800 block mb-1">
                        Bolivianos Payout
                      </span>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        >
                          ...
                          <div className="text-[10px] text-slate-600 font-medium">{bank.desc}</div>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-2xl neu-input text-xs text-slate-900 font-bold"
                      />
                    </div>
                    <div>
                      <label className="text-xs font-bold text-slate-700 block mb-1">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-2xl neu-input text-xs text-slate-900 font-mono font-bold"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-5 animate-in zoom-in-95 text-center py-4">
                  ...
                  <div className="neu-inset p-4 rounded-2xl space-y-2 text-xs font-mono text-slate-800 max-w-md mx-auto text-left">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-emerald-700 font-black">Confirmed on Stellar</span>
                    </div>
                  </div>

                  <button
                    onClick={() => setIsSuccess(false)}
                    className="px-6 py-2.5 rounded-2xl neu-btn text-xs font-bold text-slate-800 hover:text-slate-950"
                  >
                    Run Another Quote
                  </button>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="neu-card rounded-3xl p-6 border border-white/80 space-y-4">
                <div className="flex items-center gap-2 text-emerald-800 text-xs font-extrabold uppercase tracking-wider">
                  <Smartphone className="w-4 h-4 text-emerald-600" /> Connected African Ingress
                </div>
                ...
                <div className="space-y-2.5 text-xs">
                  <div className="neu-inset p-3 rounded-2xl flex items-center justify-between">
                    <div>
                      <p className="font-black text-slate-900">Kenya M-Pesa</p>
                      <span className="text-[10px] text-slate-600 font-medium">STK Push (KES)</span>
                    </div>
                    <span className="font-mono font-black text-emerald-800">129.50 KES</span>
                  </div>

                  <div className="neu-inset p-3 rounded-2xl flex items-center justify-between">
                    <div>
                      <p className="font-black text-slate-900">Nigeria NGN Bank</p>
                      <span className="text-[10px] text-slate-600 font-medium">Paystack / Virtual Acct</span>
                    </div>
                    <span className="font-mono font-black text-indigo-800">1,485 NGN</span>
                  </div>

                  <div className="neu-inset p-3 rounded-2xl flex items-center justify-between">
                    <div>
                      <p className="font-black text-slate-900">Ghana MoMo</p>
                      <span className="text-[10px] text-slate-600 font-medium">MTN / Airtel (GHS)</span>
                    </div>
                    <span className="font-mono font-black text-amber-800">15.20 GHS</span>
                  </div>
                </div>
              </div>

              {/* Telegram Support Card */}
              <div className="neu-card rounded-3xl p-6 border border-indigo-300/80 space-y-3 bg-indigo-50/60">
                <div className="flex items-center gap-2 text-indigo-800 text-xs font-extrabold uppercase tracking-wider">
                  <ShieldCheck className="w-4 h-4 text-indigo-600" /> Flagship Test Team
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl neu-btn text-xs font-bold text-indigo-800 hover:text-indigo-950"
                >
