...
export function Footer() {
  return (
    <footer className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-8 border-t border-slate-300/40 text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="text-indigo-600 hover:text-indigo-800 flex items-center gap-1 font-semibold transition-colors"
        >
